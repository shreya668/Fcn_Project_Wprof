...
def main():
    ...
    '''
    '''
    dir_list.append('./data/desktop_wifi-fast_mixed200_orig_inline_with_cache_0')
    dir_list.append('./data/desktop_wifi-fast_mixed200_orig_inline_with_cache_1')
    dir_list.append('./data/desktop_wifi-fast_mixed200_orig_inline_with_cache_2')
    dir_list.append('./data/desktop_wifi-fast_mixed200_orig_inline_withoutcache')
    '''

    #dir_list.append('./data/desktop_wifi_with_cache')
    #dir_list.append('./itr1_cleared_cache')
    #dir_list.append('./itr3_wihcache')
    dir_list.append('./js/js0')

    #dir_list.append('./desktop_wifi-fast_mixed200_orig_inline')
    #dir_list.append('./newLogs/desktop_wifi-fast_mixed200_orig_inline')
    #dir_list.append('./desktop_wifi-fast_mixed200_orig_inline_with_dns')
