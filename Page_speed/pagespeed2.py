...
def main():
    ...
    exp_type = 'inline'
    arch_dir = '/home/shreya/page_speed/arch_dir'
    my_profiles = [
                   # Wi-Fi ac
                   {'conn_type':'wifi-fast',
                  'device_type': 'desktop',
        ...
        for site in top_sites:
            try:
                for net_profile in my_profiles:
                    ...
                    apachectl_orig = apache_conf.ApacheConf(net_profile['device_type'], net_profile['conn_type'], input_file.split('.')[0], 'orig', '/home/shreya')
                    apachectl_modified = apache_conf.ApacheConf(net_profile['conn_type'], net_profile['conn_type'],  input_file.split('.')[0], exp_type, '/home/shreya')
                    ...
                    conv_orig.do_analysis(net_profile, 'orig', exp_type)
